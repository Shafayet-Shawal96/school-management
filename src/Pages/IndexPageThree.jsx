    ...
    <Fragment>
      ...
      <div class="slider-area ">
        <div class="slider-active-2 owl-carousel nav-style-2">
          <div
            class="single-slider slider-height-3 bg-img pt-170"
              ...
              <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-12 col-sm-6">
                  <div class="slider-content-3 slider-animated-2 pt-115 ml-55">
                    <h1 class="animated">
                      <span class="text-blue">S</span>hop
                      <span class="text-pink">P</span>ing Time
                    </h1>
                    <p class="animated">
      ...
      <div class="popular-product-area pb-100">
        <div class="container">
      ...
      <div
        class="discount-area bg-img pt-110 pb-90"
      ...
      <div class="best-sale-area pt-130 pb-100">
        <div class="container">
          <div class="section-title mb-75">
            <h2>
              Best <span>Sale</span>
                  ...
                  <div class="product-details-content quickview-content">
                    ...
                    <div class="pro-details-quality mt-50 mb-45">
                      ...
                      <div class="pro-details-cart">
                        <a class="default-btn btn-hover" href="/">
                          Add To Cart
                        </a>
                      </div>
