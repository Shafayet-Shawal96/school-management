    ...
    <Fragment>
      ...
      <div class="slider-area">
        <div class="slider-active owl-carousel">
          <div
            class="single-slider slider-height-1 bg-img"
              ...
              <div class="single-choose-us choose-bg-light-blue">
                ...
                <div class="choose-content">
                  ...
                  <p>
                    ...
                    adipisicing elit, sed do exercitation.{" "}
                  </p>
                </div>
              </div>
            </div>
      ...
      <div
        class="course-area bg-img pt-130 pb-10"
              ...
              <div class="testi-content-wrap">
                ...
                <div class="row g-0">
                  <div class="ms-auto col-lg-6 col-md-12">
                    <div
                      class="testi-content bg-img default-overlay"
      ...
      <div
        class="register-area bg-img pt-130 pb-130"
      ...
      >
        <div class="container">
          <div class="section-title-2 mb-75 white-text">
            ...
            <p>
              Winter Admission Is Going On. We are announcing Special discount
              for winter batch 2019.
            </p>
          </div>
                      ...
                      <div class="col-lg-12">
                        <div class="contact-form-style">
                          <textarea
                            ...
                            placeholder="Message"
                          ></textarea>
                          <button class="submit default-btn" type="submit">
                            SUBMIT NOW
                          </button>
                        </div>
                      </div>
      ...
      <div
        class="event-area bg-img default-overlay pt-130 pb-130"
            ...
            <div class="col-lg-3 col-md-6">
              <div class="single-blog mb-30">
                ...
                <div class="blog-content-wrap">
                  ...
                  <div class="blog-date">
                    <a href="/">
                      <i class="fa fa-calendar-o"></i> Feb, 18th 2017
                    </a>
                  </div>
                </div>
              </div>
            ...
            <div class="col-lg-3 col-md-6">
              <div class="single-blog mb-30">
                ...
                <div class="blog-content-wrap">
                  ...
                  <div class="blog-date">
                    <a href="/">
                      <i class="fa fa-calendar-o"></i> Oct, 14th 2018
                    </a>
                  </div>
                </div>
              </div>
            ...
            <div class="col-lg-3 col-md-6">
              <div class="single-blog mb-30">
                ...
                <div class="blog-content-wrap">
                  ...
                  <div class="blog-date">
                    <a href="/">
                      <i class="fa fa-calendar-o"></i> Jun, 21th 2017
                    </a>
                  </div>
                </div>
              </div>
