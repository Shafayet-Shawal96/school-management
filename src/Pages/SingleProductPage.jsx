  ...
  return (
    <Fragment>
      ...
      <div class="breadcrumb-area">
        <div
          class="breadcrumb-top default-overlay bg-img breadcrumb-overly-4 pt-100 pb-95"
          ...
          <div class="container">
            <ul>
              <li>
                <a href="/">Home</a>{" "}
                <span>
                  <i class="fa fa-angle-double-right"></i>Product Details
                </span>
              </li>
            </ul>
          </div>
          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="product-details-img">
                ...
                <div
                  id="gallery"
                  class="mt-15 product-dec-slider dec-slider-overlay"
                >
                  <a
                    class="active"
